...
public class NewElementReader {
     ...
     */
    public LabWork readNewElementFromConsole() {
     ...
     */
    public LabWork readNewElementFromScript(String argumentLine) {
        String[] elementValueList = argumentLine.split(";");
        ...
        try {
            ...
            return new LabWork(nameOfNewElement, coordinatesOfLab, minimalPoint, difficulty, author);
