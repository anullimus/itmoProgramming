...
public class CommandInformer {
    ...
    private static final Map<String, Class<?>> commandsNeedArgument;
    ...
    static {
        ...
        commandsNeedArgument.put("remove_greater", Long.class);
        commandsNeedArgument.put("remove_lower", Long.class);
