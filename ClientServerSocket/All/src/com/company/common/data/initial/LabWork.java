...
/**
 * Main data class LabWork. Objects of this class will be figured in <Strong>collection</Strong>.
 */
public class LabWork implements Comparable<LabWork> {
    ...
    public LabWork(String name, Coordinates coordinates, Float minimalPoint, Difficulty difficulty, Person author) {
        idGenerator = FileManager.MAX_ID;
        idGenerator++;
        this.id = idGenerator;
        ...
        try {
            ...
            System.out.println(CommandInformer.PS1 + "Вы ввели некорректные данные и попали туда, куда не стоило " +
