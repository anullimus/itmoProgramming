...
import com.company.data.initial.LabWork;
...
public class FileLogic {
    ...
    public FileLogic(String collectionPath) {
    ...
    /**
     * Reads json file with LabWork{@link LabWork} elements in collection{@link CollectionLogic}.
     *
    ...
    /**
     * Extremely saves the collection elements when program throws some danger exception.
     *
     * @param userCommand commands that manage the collection.
     * @param collection  is actual collection
     */
    protected void makeDump(String[] userCommand, LinkedHashSet<LabWork> collection) {
        fileCollection = new File("dump.json");
        save(userCommand, collection);
    }

    /**
     * Saves the elements to collection{@link CollectionLogic}.
     *
     * @param userCommand commands that manage the collection.
     * @param collection  is actual collection
     */
    public void save(String[] userCommand, LinkedHashSet<LabWork> collection) {
    ...
    public boolean equals(Object otherObject) {
        ...
        if (!(otherObject instanceof FileLogic)) return false;
        FileLogic fileLogic = (FileLogic) otherObject;
        return Objects.equals(fileCollection, fileLogic.fileCollection) && Objects.equals(collection, fileLogic.collection);
    }
