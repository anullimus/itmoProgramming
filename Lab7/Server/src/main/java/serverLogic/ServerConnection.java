...
//               todo: логирование
                logger.info("Клиент: " + socket + " отправил запрос: "
                ...
                //               todo: логирование
                logger.info("Результат исполнения запроса: {}", response);
...
//               todo: логирование
        ...
        try {
            ...
            while (last > 0) {
                logger.debug("Осталось прочитать {} байт", last);
//                todo: логирование
                ...
                logger.debug("Прочитано {} байт", bytes);
//                todo: логирование
